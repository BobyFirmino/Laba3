...
public class Session {
    ...
    public Session(CinemaTheatre theatre, Movie movie, Date time, int hallNumber)
    {
    ...
    public Session(CinemaTheatre theatre, Movie movie, Date time, int hallNumber, String hallType, int totalRevenue)
    {
        this.theatre=theatre;
        this.movie=movie;
        this.time=time;
    ...
    public static ArrayList<Session> getShows(String sep) throws IOException
    {
        ArrayList<CinemaTheatre> theatres = CinemaTheatre.getTheatres(";");
        ArrayList<Movie> movies = Movie.getMovies(";");
        ...
        while(line != null) {
            ...
            result.add(new Session(theatres.get(Integer.parseInt(params[0])), movies.get(Integer.parseInt(params[1])), new Date(Integer.parseInt(params[2]), Integer.parseInt(params[3]), Integer.parseInt(params[4]), Integer.parseInt(params[5]), Integer.parseInt(params[6]), 0), Integer.parseInt(params[7]), params[8], Integer.parseInt(params[9])));
            line = br.readLine();
        }
        return result;
    }
    public boolean Equals(Session show)
    {
