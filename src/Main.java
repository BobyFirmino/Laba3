...
public class Main {
    public static void chooseShow(ArrayList<Sessions> shows, ArrayList<Client> clients, ArrayList<Movie> movies, ArrayList<CinemaTheatre> theatres, ArrayList<Advertiser> ads) throws IOException
    {
        while(true) {
            ...
            clients.get(clientInd).BuyTicket(shows, movies, theatres, ads);
    ...
    public static void AdvMode(ArrayList<CinemaTheatre> theatres, ArrayList<Advertiser> ads)
    {
        ...
        try {
            ...
            for (int i = 0; i < ads.size(); i++) {
                if (ads.get(i).Equals(name, phone, email))
                    adsInd = i;
            }
            if (adsInd == ads.size()) {
                ...
                System.out.println("Ваша реклама: "+ads.get(adsInd).returnAd());
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        while (true)
        {
            ...
            if(identifier.equals("c")) {
                chooseShow(shows, clients, movies, theatres, ads);
            }
            else
            {
